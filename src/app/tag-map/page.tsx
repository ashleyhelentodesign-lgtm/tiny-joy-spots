...
export const metadata: Metadata = {
  title: "tiny joy — explore mode · Joy Spots",
  description:
    "Explore how joy spots connect through shared tags—drag, scroll, and open each post.",
};

export default async function TagMapPage() {
